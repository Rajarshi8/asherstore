            ...
            <div className="flex flex-col gap-3 pt-2">
              ...
              <div className="pt-1">
                <Link
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group relative inline-flex items-center gap-2.5 rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-4 py-2.5 text-xs font-extrabold uppercase tracking-wider text-emerald-400 transition-all duration-300 hover:border-emerald-400 hover:bg-emerald-500/20 hover:text-white hover:scale-[1.02] shadow-sm"
                >
